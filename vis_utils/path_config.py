...
class PathConfig(object):
    def __init__(self, dataset):
        if dataset == 'scannet':
            self.metadata_root = '../RfDNet/datasets/scannet'
            self.split_files = ['../RfDNet/datasets/splits/scannet/scannetv2_train.txt',
                                '../RfDNet/datasets/splits/scannet/scannetv2_val.txt']
            all_scenes = []
